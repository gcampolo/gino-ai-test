...
label das_no_access:
  ...
  python:
        print("DEBUG — das_no_access triggered")
        print("DEBUG — week =", week)
        print("DEBUG — dark_arts_store.week =", dark_arts_store.week)
        print("DEBUG — access_count =", dark_arts_store.access_count)
        print("DEBUG — encounters =", dark_arts_store.encounters)
        print("DEBUG — has das_access =", 'das_access' in player.tags)
  ...
  if not 'das_access' in player.tags:
    ...
    if week > dark_arts_store.week and dark_arts_store.encounters < 4:
      ...
      python:
        print("DEBUG — Conditions passed. access_count is now:", dark_arts_store.access_count)
